...
3. Don't **spam or flood**, unless you're occasionally sending a link to e.g. Twitch when you're streaming RealistikOsu! when no discussion is going on.
...
3. Multiaccounts are **NOT** allowed, with the **SOLE EXCEPTION OF CHAT BOTS**.  If you are developing one and need an account for it,  mail [support](mailto:rosusupport@protonmail.com) (or a [dev](mailto:rosusupport@protonmail.com))
4. We reserve the right to change these rules as we see fit.

<h3><i class="list layout icon"></i> Miscellaneous</h3>

1. You can change your profile flag mailing [support](mailto:rosusupport@protonmail.com), and sending a picture with a valid document and a post-it or a piece of paper with your RealistikOsu! name.
