...
old_id: 12
---
If you're having troubles connecting to RealistikOsu! or the switcher doesn't install the certificate properly, you can try installing it manually.
...
...you can try to remove all existing RealistikOsu! certificates and install the certificate again. Follow these steps:
...
- Click on **Test RealistikOsu! connection** and you should see "OK" for every domains  
**If the inspect dialog is fine but you still can't connect to RealistikOsu! from the game client, try running osu! as administrator**.
