---
title: "How to connect to RealistikOsu! (Linux)"
old_id: 14
---
...
You can use this command to append the most up to date RealistikOsu! redirections to your hosts file:
```
...
Click *Browse...* then select the RealistikOsu! certificate.
...
After that is done, you can start the client up, and log in with your RealistikOsu! credentials.
