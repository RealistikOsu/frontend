---
title: "Come connettersi a RealistikOsu! (Linux)"
...
Puoi usare questo comandi per aggiungere i reindirizzamenti di RealistikOsu! più aggiornati al tuo file hosts:
```
