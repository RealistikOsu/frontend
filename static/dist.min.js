...
var keyPlurals = {
    ...
    singlePageSnippets = {
        ...
        "/donate": function() {
            ...
            var t = {},
            n = e.noUiSlider;
            let bruh_data = {"EUR":36542.86,"USD":39105.93}
            t = bruh_data, n.on("update", function() {
                var e = n.get(),
                    i = Math.pow(3* e, .7),
                    o = i / t.EUR,
                    r = o * t.USD;
        ...
        "/rank_request" : function() {
            ...
            var bmapSetIDRegex = /^https?:\/\/(ppy|ussr).(sh|pl)\/beatmapsets\/(\d+)/gi;
            $("#b-form")
              .submit(function(e) {
                ...
                if (bmapIDMatch != null) {
                    ...
                    postData.set_id = parseInt(bmapSetIDMatch[3])
                }
