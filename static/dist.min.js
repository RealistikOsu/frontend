...
function _api(e, t, n, i, o, r, a) {
    ...
    var s = "An error occurred while contacting the RealistikOsu API. Please report this to RealistikDash or a RealistikOsu dev.";
    $.ajax({
        method: r ? "POST" : "GET",
        dataType: "json",
        url: e + t,
            ...
            function e() {
                ...
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + "&rx=" + rx + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("leaderboard", {
                    ...
                    e.users.forEach(function(e) {
                        if (rx == 1) {
                            n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/rx/u/" + e.id + "' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                        }
                        if (rx == 2) {
                            n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/ap/u/" + e.id + "' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                        }
                        if (rx == 0) {
                            n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/u/" + e.id +"' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                        }
